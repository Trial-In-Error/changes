...
HEXAGRAM_TYPE hexagramList[64];
HEXAGRAM_TYPE hexPointer;
...
void hexSetup() {
  ...
  memcpy(hexagramList[0].hexagram, temp0, sizeof(hexagramList[0]));
  ...
  memcpy(hexagramList[1].hexagram, temp1, sizeof(hexagramList[1]));
  ...
  memcpy(hexagramList[2].hexagram, temp2, sizeof(hexagramList[2]));
  ...
  memcpy(hexagramList[3].hexagram, temp3, sizeof(hexagramList[3]));
  ...
  memcpy(hexagramList[4].hexagram, temp4, sizeof(hexagramList[4]));
  ...
  memcpy(hexagramList[5].hexagram, temp5, sizeof(hexagramList[5]));
  ...
  memcpy(hexagramList[6].hexagram, temp6, sizeof(hexagramList[6]));
  ...
  memcpy(hexagramList[7].hexagram, temp7, sizeof(hexagramList[7]));
  ...
  memcpy(hexagramList[8].hexagram, temp8, sizeof(hexagramList[8]));
  ...
  memcpy(hexagramList[9].hexagram, temp9, sizeof(hexagramList[9]));
  ...
  memcpy(hexagramList[10].hexagram, temp10, sizeof(hexagramList[10]));
  ...
  memcpy(hexagramList[11].hexagram, temp11, sizeof(hexagramList[11]));
  ...
  memcpy(hexagramList[12].hexagram, temp12, sizeof(hexagramList[12]));
  ...
  memcpy(hexagramList[13].hexagram, temp13, sizeof(hexagramList[13]));
  ...
  memcpy(hexagramList[14].hexagram, temp14, sizeof(hexagramList[14]));
  ...
  memcpy(hexagramList[15].hexagram, temp15, sizeof(hexagramList[15]));
  ...
  memcpy(hexagramList[16].hexagram, temp16, sizeof(hexagramList[16]));
  ...
  memcpy(hexagramList[17].hexagram, temp17, sizeof(hexagramList[17]));
  ...
  memcpy(hexagramList[18].hexagram, temp18, sizeof(hexagramList[18]));
  ...
  memcpy(hexagramList[19].hexagram, temp19, sizeof(hexagramList[19]));
  ...
  memcpy(hexagramList[20].hexagram, temp20, sizeof(hexagramList[20]));
  ...
  memcpy(hexagramList[21].hexagram, temp21, sizeof(hexagramList[21]));
  ...
  memcpy(hexagramList[22].hexagram, temp22, sizeof(hexagramList[22]));
  ...
  memcpy(hexagramList[23].hexagram, temp23, sizeof(hexagramList[23]));
  ...
  memcpy(hexagramList[24].hexagram, temp24, sizeof(hexagramList[24]));
  ...
  memcpy(hexagramList[25].hexagram, temp25, sizeof(hexagramList[25]));
  ...
  memcpy(hexagramList[26].hexagram, temp26, sizeof(hexagramList[26]));
  ...
  memcpy(hexagramList[27].hexagram, temp27, sizeof(hexagramList[27]));
  ...
  memcpy(hexagramList[28].hexagram, temp28, sizeof(hexagramList[28]));
  ...
  memcpy(hexagramList[29].hexagram, temp29, sizeof(hexagramList[29]));
  ...
  memcpy(hexagramList[30].hexagram, temp30, sizeof(hexagramList[30]));
  ...
  memcpy(hexagramList[31].hexagram, temp31, sizeof(hexagramList[31]));
  ...
  memcpy(hexagramList[32].hexagram, temp32, sizeof(hexagramList[32]));
  ...
  memcpy(hexagramList[33].hexagram, temp33, sizeof(hexagramList[33]));
  ...
  memcpy(hexagramList[34].hexagram, temp34, sizeof(hexagramList[34]));
  ...
  memcpy(hexagramList[35].hexagram, temp35, sizeof(hexagramList[35]));
  ...
  memcpy(hexagramList[36].hexagram, temp36, sizeof(hexagramList[36]));
  ...
  memcpy(hexagramList[37].hexagram, temp37, sizeof(hexagramList[37]));
  ...
  memcpy(hexagramList[38].hexagram, temp38, sizeof(hexagramList[38]));
  ...
  memcpy(hexagramList[39].hexagram, temp39, sizeof(hexagramList[39]));
  ...
  memcpy(hexagramList[40].hexagram, temp40, sizeof(hexagramList[40]));
  ...
  memcpy(hexagramList[41].hexagram, temp41, sizeof(hexagramList[41]));
  ...
  memcpy(hexagramList[42].hexagram, temp42, sizeof(hexagramList[42]));
  ...
  memcpy(hexagramList[43].hexagram, temp43, sizeof(hexagramList[43]));
  ...
  memcpy(hexagramList[44].hexagram, temp44, sizeof(hexagramList[44]));
  ...
  memcpy(hexagramList[45].hexagram, temp45, sizeof(hexagramList[45]));
  ...
  memcpy(hexagramList[46].hexagram, temp46, sizeof(hexagramList[46]));
  ...
  memcpy(hexagramList[47].hexagram, temp47, sizeof(hexagramList[47]));
  ...
  memcpy(hexagramList[48].hexagram, temp48, sizeof(hexagramList[48]));
  ...
  memcpy(hexagramList[49].hexagram, temp49, sizeof(hexagramList[49]));
  ...
  memcpy(hexagramList[50].hexagram, temp50, sizeof(hexagramList[50]));
  ...
  memcpy(hexagramList[51].hexagram, temp51, sizeof(hexagramList[51]));
  ...
  memcpy(hexagramList[52].hexagram, temp52, sizeof(hexagramList[52]));
  ...
  memcpy(hexagramList[53].hexagram, temp53, sizeof(hexagramList[53]));
  ...
  memcpy(hexagramList[54].hexagram, temp54, sizeof(hexagramList[54]));
  ...
  memcpy(hexagramList[55].hexagram, temp55, sizeof(hexagramList[55]));
  ...
  memcpy(hexagramList[56].hexagram, temp56, sizeof(hexagramList[56]));
  ...
  memcpy(hexagramList[57].hexagram, temp57, sizeof(hexagramList[57]));
  ...
  memcpy(hexagramList[58].hexagram, temp58, sizeof(hexagramList[58]));
  ...
  memcpy(hexagramList[59].hexagram, temp59, sizeof(hexagramList[59]));
  ...
  memcpy(hexagramList[60].hexagram, temp60, sizeof(hexagramList[60]));
  ...
  memcpy(hexagramList[61].hexagram, temp61, sizeof(hexagramList[61]));
  ...
  memcpy(hexagramList[62].hexagram, temp62, sizeof(hexagramList[62]));
  ...
  memcpy(hexagramList[63].hexagram, temp63, sizeof(hexagramList[63]));
}
...
void setup() {
  ...
  for(uint8_t count = 0; count < 6; count++) {
    Serial.print(String(hexagramList[0].hexagram[count]) + " ");    
  }
  Serial.print(F("^^^^^^^^^^\n"));
...
void loop () {
  hexPointer = generateHexagram();
  drawHexagram(hexPointer.hexagram);
  ...
  for(uint8_t count = 0; count < 6; count++) {
    Serial.print(String(hexPointer.hexagram[count]) + " ");    
  }
